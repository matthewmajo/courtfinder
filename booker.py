...
# 1. YOUR DETAILS
# ==========================================
BEARER_TOKEN = "v4.local.TY1kn3DzrXLoHBRRC5DxBnVX7Xdivj3D6owbNxnTngef_2k1OYbLj5zbT65_E2WZszGqPEB9Y_LyRgxDPUibpnkJNm02CR18st1NQ9D3fKvKN1k560257wafsxYF0_3qPwjnv2alNwnnrNQT5zQ993Icw5w6-nUVvtBCLV0zFc2rKm51bYnLHTVUcR8RrjOfnn1yxlfJm5FZN3wp"

TARGET_DATE = "2026-07-24"

DISCORD_WEBHOOK = "https://discord.com/api/webhooks/1527699581184508067/kw7Bvq3YS89BOl5NQ-2dDaFRUvB9p_19Bk_LebeaiellQs7k3HxOC-oNmDN5rFrWk4Rn"
...
def expand_priority_rules(rules):
    ...
    for rule in rules:
        ...
        for hour in range(start_hour, end_hour + 1):
            time_str = f"{hour:02d}:00" # Formats integer 7 as "07:00"
